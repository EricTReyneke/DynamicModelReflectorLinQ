namespace Business.DynamicModelReflector.Interfaces
{
    public interface IModelReflector
    {
        ...
        ILoadJoinFactory<TModel> Load<TModel>(TModel model) where TModel : class, new();
        ...
        /// <returns>Load facotry which allowes for diffrent query operation</returns>
        ILoadJoinFactory<TModel> Load<TModel>(IEnumerable<TModel> models) where TModel : class, new();
